...
- **AzureOpenAI (AI Foundry)** provides chat completions (we’ll use `gpt-4o-mini`) from Azure AI Foundry deployments.  
...
def ask_azure_chatbot(query: str, top_k: int = 3):
    print(f"Retrieving context from Azure AI Search for: "{query}"")
